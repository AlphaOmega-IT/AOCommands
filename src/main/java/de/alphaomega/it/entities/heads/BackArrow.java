...
public class BackArrow extends AHead {
    ...
    public Map<String, String> setNames() {
        getNames().put(LANGUAGE.GERMAN.getLocale(), pl.getTranslations().get(LANGUAGE.GERMAN.getLocale()).getString("backArrowName"));
        getNames().put(LANGUAGE.ENGLISH.getLocale(), pl.getTranslations().get(LANGUAGE.ENGLISH.getLocale()).getString("backArrowName"));
        getNames().put(LANGUAGE.BRAZILIAN.getLocale(), pl.getTranslations().get(LANGUAGE.BRAZILIAN.getLocale()).getString("backArrowName"));
        return getNames();
    }
    ...
    public Map<String, List<String>> setLore() {
        try {
            getLores().put(LANGUAGE.GERMAN.getLocale(), pl.getTranslations().get(LANGUAGE.GERMAN.getLocale()).getConfigurationSection("backArrowLore").getValues(false).values().stream().map(Object::toString).toList());
            getLores().put(LANGUAGE.ENGLISH.getLocale(), pl.getTranslations().get(LANGUAGE.ENGLISH.getLocale()).getConfigurationSection("backArrowLore").getValues(false).values().stream().map(Object::toString).toList());
            getLores().put(LANGUAGE.BRAZILIAN.getLocale(), pl.getTranslations().get(LANGUAGE.BRAZILIAN.getLocale()).getConfigurationSection("backArrowLore").getValues(false).values().stream().map(Object::toString).toList());
        } catch (Exception exc) {
